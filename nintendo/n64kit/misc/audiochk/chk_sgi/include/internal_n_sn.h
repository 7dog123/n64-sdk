...
#define alDebugGetMaxEvents	n_alDebugGetMaxEvents
#define alDebugResetMaxEvents	n_alDebugResetMaxEvents
#define alDebugGetMaxUpdates	n_alDebugGetMaxUpdates
#define alDebugResetMaxUpdates	n_alDebugResetMaxUpdates
