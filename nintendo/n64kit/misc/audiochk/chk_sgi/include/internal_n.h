...
extern u32	n_alDebugGetMaxEvents(void);
extern void	n_alDebugResetMaxEvents(void);
extern u32	n_alDebugGetMaxUpdates(void);
extern void	n_alDebugResetMaxUpdates(void);
