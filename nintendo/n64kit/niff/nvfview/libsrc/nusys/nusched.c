...
/*	1998/12/16							*/
/*		Fixed so that if a PRENMI message is received 		*/
/*		before client registration, a PRENMI message is dispatched 	*/
...
/*									*/
/*======================================================================*/
/* $Id: nusched.c,v 1.10 1999/01/23 12:58:51 ohki Exp $		*/
/*======================================================================*/
...
u32		nuScRetraceCounter;	/* Retrace counter */
u8		nuScPreNMIFlag;
