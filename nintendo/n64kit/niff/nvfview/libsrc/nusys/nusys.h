...
/* message buffer size.			*/
/* Otherwise, a task structure in use	*/
/* may be used.				*/
/*--------------------------------------*/
...
/* Frame buffer allocated at the top of	*/
/* RDRAM by default			*/
/* 320x240 16bit triple buffer		*/
/*--------------------------------------*/
...
/*--------------------------------------*/
/* Z buffer allocated at the bottom	*/
...
/*----------------------------------------------------------------------*/
/* Define messages to be sent to the Controller Manager 		*/
/*----------------------------------------------------------------------*/
...
typedef struct st_ContData {
    ...
    s8	stick_y;		/* Range acutally used -63 <= stick Y <= 63*/
    u8	errno;			/* Error				*/
...
extern NUContReadFunc	nuContReadFunc;		/* Callback function		*/
						/* When controller read ends	*/
/*--------------------------------------*/
/* Debug 		 		*/
/*--------------------------------------*/
...
/*	Obtains loaded data from the Controller Manager.		*/
/*									*/
