...
/* --------------------------------------------------------------------------
   definition of segments, etc.
   (also valid with specs)
 -------------------------------------------------------------------------- */
...
/* --------------------------------------------------------------------------
	macros that are convenient to have
 -------------------------------------------------------------------------- */
/* macro that can be used as expression values (no semicolon needed) */
...
/* the following are macros that can be used as functions  (semicolons necessary)  */
