...
/*  1998/ 6/24	Timing of Auto-repeat was made faster.			*/
/*======================================================================*/

/*----------------------------------------------------------------------
  Module to manage Menu
  * Basic operation of Menu 
    Up and Down arrows ...... Select item ( MENU_ITEM )  
    Left and Right arrows...... Action various every item. 
		Usually, nothing happens, but an item with parameters                  
...
/*----------------------------------------------------------------------
  ...
  For example, if Right arrow and Up arrow are pressed down simultaneously, 
  it is considered no input.  Also, auto-repeat is realized by this function. 
----------------------------------------------------------------------*/
static int parse_input( EXCONTPAD *pad )
{
...
----------------------------------------------------------------------*/
void menu( MENU *root_menu, EXCONTPAD *pad, void *option )
{
    MENU	*new_menu;
    MENU_ITEM	*item;
    int		input;
