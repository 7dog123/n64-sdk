...
/*----------------------------------------------*/
/*  The process of the controller pack error 	*/
/*  IN:	pendingGfx				*/
/*  RET:None					*/
/*----------------------------------------------*/
void
...
/*------------------------------------------------------*/
/*  Record pad data to the controller pack 	*/
/*  IN:	None 						*/
/*  RET:None 						*/
/*------------------------------------------------------*/
void
...
/*------------------------------------------------------*/
/*  Read pad data from the controller pack 	*/
/*  IN:	None 						*/
/*  RET:None 						*/
/*------------------------------------------------------*/
void
...
/*--------------------------------------------------------------*/
/*  Check the status of the opened controller pack 	*/
/*  IN:	None 							*/
/*  RET:None 							*/
/*--------------------------------------------------------------*/
int
